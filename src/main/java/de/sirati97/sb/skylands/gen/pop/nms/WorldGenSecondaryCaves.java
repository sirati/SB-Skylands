...
public class WorldGenSecondaryCaves extends WorldGenBase {
    ...
    protected void a(long var1, int var3, int var4, ChunkSnapshot var5, double var6, double var8, double var10, float var12, float var13, float var14, int var15, int var16, double var17) {
        ...
        float var23 = 0.0F;
        float var24 = 0.0F;
        Random var25 = new Random(new Random(var1).nextLong()); //different seed. different caves
        if(var16 <= 0) {
                                ...
                                if(var54 * var54 + var57 * var57 < 1.0D) {
                                    for(int var60 = var46; var60 > var45; --var60) {
                                        ...
                                        if(var61 > -0.7D && var54 * var54 + var61 * var61 + var57 * var57 < 1.0D) {
                                            ...
                                            IBlockData var64 = (IBlockData) Objects.firstNonNull(var5.a(var51, var60 + 1, var56), Blocks.AIR.getBlockData());
                                            ...
                                            if(this.a(var63, var64)) {
                                                if(var60 - 1 < 10) {
                                                    var5.a(var51, var60, var56, Blocks.LAVA.getBlockData());
                                                } else {
                                                    var5.a(var51, var60, var56, Blocks.AIR.getBlockData());
                                                    if(var64.getBlock() == Blocks.SAND) {
                                                        var5.a(var51, var60 + 1, var56, var64.get(BlockSand.VARIANT) == BlockSand.EnumSandVariant.RED_SAND?Blocks.RED_SANDSTONE.getBlockData():Blocks.SANDSTONE.getBlockData());
                                                    }

                                                    if(var59 && var5.a(var51, var60 - 1, var56).getBlock() == Blocks.DIRT) {
                                                        var66.c(var51 + var3 * 16, 0, var56 + var4 * 16);
                                                        var5.a(var51, var60 - 1, var56, this.c.getBiome(var66).ak.getBlock().getBlockData());
                                                    }
                                                }
                                            }
                                        }
